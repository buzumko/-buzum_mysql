...
активность: делает посты, пишет сообщени€, читает сообщени€, ставит лайки, отправл€ют запросы на дружбу, участвуют в группах
*/
...
-- считаем количество исход€щих сообщений
DESC messages;
...
-- считаем количество вход€щих прочитанных сообщений
DESC messages;
...
-- количество лайков от пользовател€
DESC likes ;
SELECT
	(
		SELECT concat_ws(' ', first_name, last_name) 
